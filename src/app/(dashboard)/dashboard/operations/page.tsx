  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-[#0D1B35] text-2xl font-bold">Operations Dashboard</h1>
          <p className="text-[#6378A0] text-sm mt-0.5">Real-time operational status and alert queue</p>
        </div>
        ...
        <div className="bg-white border border-[#D9E2F0] rounded-xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-[#6378A0] text-xs mt-0.5">Assets & sensors per site</p>
            </div>
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm bg-[#D9E2F0]" /><span className="text-[#6378A0] text-xs">Sensors</span></div>
          </div>
        </div>
      </div>
          ...
          <div>
            {recentAlerts.length === 0 ? (
              <div className="flex flex-col items-center py-14">
                ...
                <p className="text-[#0D1B35] font-semibold">All clear</p>
                <p className="text-[#6378A0] text-sm mt-1">No open alerts at this time</p>
              </div>
            ) : (
              recentAlerts.map((alert) => {
                ...
                return (
                  <a
                    ...
                    key={alert.id}
                    className="flex items-center gap-4 px-5 py-4 border-b border-[#E4EAF5] hover:bg-[#F2F5FB] transition-colors last:border-0"
                  >
                    <span
                    ...
                    <div className="text-right flex-shrink-0 space-y-1">
                      ...
                      <p className="text-[#6378A0] text-[10px] flex items-center gap-1 justify-end">
            ...
            {sites.map((site, i) => {
              ...
              return (
                <a
                  href={`/sites/${site.id}`}
                  key={site.id}
                  className="flex items-center justify-between p-3 rounded-xl border border-[#E4EAF5] hover:border-[#F5E6B5] hover:bg-[#FEF7E6] transition-all"
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-[#0D1B35] text-sm font-semibold leading-tight">{site.name}</p>
                      <p className="text-[#6378A0] text-xs">Operational</p>
                    </div>
                  </div>
                  <span
