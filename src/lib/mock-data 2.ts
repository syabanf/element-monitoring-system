// Static dummy data matching the Prisma schema.
// Used when DATABASE_URL is not set (local demo / Vercel preview).

import { PillarType, AlertSeverity, AlertStatus, AlertType, SensorStatus, AssetStatus, WorkOrderStatus, QualityStatus, Role } from "@prisma/client";
...
const pillars: PillarType[] = [PillarType.ELECTRICITY, PillarType.WATER, PillarType.WASTEWATER, PillarType.GAS_AIR, PillarType.ENVIRONMENT, PillarType.THERMAL_HVAC, PillarType.COMPRESSED_AIR];

export const MOCK_ASSETS = [
  { id: "ast_01", siteId: "ste_1", zoneId: null, name: "Transformator 150kV",    code: "TR-001", assetType: "Transformer",    pillar: PillarType.ELECTRICITY,    manufacturer: "ABB",       model: "ONAN 150kV",    serialNumber: "TR20210001", installDate: d(500), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_02", siteId: "ste_1", zoneId: null, name: "Panel Distribusi MV",    code: "PD-001", assetType: "Switchgear",     pillar: PillarType.ELECTRICITY,    manufacturer: "Schneider", model: "SM6",           serialNumber: "PD20210002", installDate: d(490), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_03", siteId: "ste_1", zoneId: null, name: "Pompa Air Pendingin",    code: "PA-001", assetType: "Pump",           pillar: PillarType.WATER,          manufacturer: "Grundfos",  model: "NB 65-160",     serialNumber: "PA20210003", installDate: d(480), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_04", siteId: "ste_1", zoneId: null, name: "Unit HVAC Gedung Kontrol", code: "HV-001", assetType: "HVAC",        pillar: PillarType.THERMAL_HVAC,   manufacturer: "Carrier",   model: "30XA",          serialNumber: "HV20210004", installDate: d(470), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_05", siteId: "ste_1", zoneId: null, name: "Monitor Kualitas Udara", code: "MU-001", assetType: "Air Monitor",   pillar: PillarType.ENVIRONMENT,    manufacturer: "Vaisala",   model: "AQT530",        serialNumber: "MU20210005", installDate: d(460), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_06", siteId: "ste_1", zoneId: null, name: "Kompresor Udara",        code: "KU-001", assetType: "Compressor",    pillar: PillarType.COMPRESSED_AIR, manufacturer: "Atlas Copco", model: "GA45+",       serialNumber: "KU20210006", installDate: d(450), status: AssetStatus.MAINTENANCE,  createdAt: d(50), updatedAt: d(0) },
  { id: "ast_07", siteId: "ste_2", zoneId: null, name: "Detektor Gas LEL",       code: "DG-001", assetType: "Gas Detector",  pillar: PillarType.GAS_AIR,        manufacturer: "Honeywell", model: "MIDAS-E-LEL",   serialNumber: "DG20210007", installDate: d(440), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_08", siteId: "ste_2", zoneId: null, name: "Analyzer Limbah Cair",   code: "AL-001", assetType: "Analyzer",      pillar: PillarType.WASTEWATER,     manufacturer: "Hach",      model: "DR6000",        serialNumber: "AL20210008", installDate: d(430), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_09", siteId: "ste_3", zoneId: null, name: "Flow Meter Induk",       code: "FM-001", assetType: "Flow Meter",    pillar: PillarType.WATER,          manufacturer: "Endress+H", model: "Promag 10",     serialNumber: "FM20210009", installDate: d(420), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_10", siteId: "ste_3", zoneId: null, name: "Panel Listrik Pompa",    code: "PL-001", assetType: "Switchgear",    pillar: PillarType.ELECTRICITY,    manufacturer: "Siemens",   model: "SIVACON S4",    serialNumber: "PL20210010", installDate: d(410), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_11", siteId: "ste_4", zoneId: null, name: "Chiller 1",              code: "CH-001", assetType: "Chiller",       pillar: PillarType.THERMAL_HVAC,   manufacturer: "Trane",     model: "RTAF 300",      serialNumber: "CH20210011", installDate: d(400), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
  { id: "ast_12", siteId: "ste_4", zoneId: null, name: "Generator Diesel",       code: "GD-001", assetType: "Generator",     pillar: PillarType.ELECTRICITY,    manufacturer: "Cummins",   model: "C500D5",        serialNumber: "GD20210012", installDate: d(390), status: AssetStatus.ACTIVE,       createdAt: d(50), updatedAt: d(0) },
];
...
export const MOCK_ALERTS = [
  { id: "alt_01", ruleId: "rul_2", assetId: "ast_06", assigneeId: "usr_5", severity: AlertSeverity.CRITICAL, alertType: AlertType.STATIC_THRESHOLD,    status: AlertStatus.INVESTIGATING, title: "Tekanan Udara Kompresor Sangat Rendah",        description: "Tekanan turun ke 6.8 bar, di bawah batas 7.0 bar", metricName: "air_press_bar", metricValue: 6.8, threshold: 7.0, openedAt: d(1), acknowledgedAt: d(1), resolvedAt: null, closedAt: null, rootCause: "Kebocoran pipa distribusi", resolution: null, slaDeadline: d(-1), createdAt: d(1), updatedAt: d(0) },
  ...
  { id: "alt_03", ruleId: "rul_5", assetId: "ast_09", assigneeId: "usr_5", severity: AlertSeverity.HIGH,     alertType: AlertType.SENSOR_OFFLINE,      status: AlertStatus.OPEN,          title: "Sensor Flow Meter PAT Offline",                description: "Tidak ada data selama > 2 jam", metricName: "vol_m3", metricValue: null, threshold: null, openedAt: d(0), acknowledgedAt: null, resolvedAt: null, closedAt: null, rootCause: null, resolution: null, slaDeadline: new Date(now.getTime() + 4 * 3600000), createdAt: d(0), updatedAt: d(0) },
  { id: "alt_04", ruleId: "rul_4", assetId: "ast_08", assigneeId: "usr_7", severity: AlertSeverity.MEDIUM,   alertType: AlertType.COMPLIANCE_EXCEEDANCE, status: AlertStatus.RESOLVED,    title: "pH Air Limbah Melewati Baku Mutu",            description: "pH 9.3 > 9.0", metricName: "ph", metricValue: 9.3, threshold: 9.0, openedAt: d(5), acknowledgedAt: d(5), resolvedAt: d(4), closedAt: d(4), rootCause: "Alkaline spill di unit proses", resolution: "Neutralisasi dengan asam sulfat", slaDeadline: d(3), createdAt: d(5), updatedAt: d(4) },
  { id: "alt_05", ruleId: "rul_3", assetId: "ast_07", assigneeId: "usr_4", severity: AlertSeverity.CRITICAL, alertType: AlertType.STATIC_THRESHOLD,    status: AlertStatus.CLOSED,        title: "Konsentrasi Gas LEL Melebihi Batas",          description: "LEL 12% > 10%", metricName: "lel_pct", metricValue: 12.0, threshold: 10.0, openedAt: d(10), acknowledgedAt: d(10), resolvedAt: d(9), closedAt: d(9), rootCause: "Kebocoran kecil katup gas alam", resolution: "Katup diganti, area di-ventilasi", slaDeadline: d(9), createdAt: d(10), updatedAt: d(9) },
  { id: "alt_06", ruleId: null,    assetId: "ast_15", assigneeId: null,    severity: AlertSeverity.LOW,      alertType: AlertType.CALIBRATION_OVERDUE, status: AlertStatus.OPEN,          title: "Kalibrasi COD Analyzer Overdue",              description: "Jadwal kalibrasi terlewat 15 hari", metricName: null, metricValue: null, threshold: null, openedAt: d(0), acknowledgedAt: null, resolvedAt: null, closedAt: null, rootCause: null, resolution: null, slaDeadline: null, createdAt: d(0), updatedAt: d(0) },
  { id: "alt_07", ruleId: null,    assetId: "ast_04", assigneeId: "usr_3", severity: AlertSeverity.MEDIUM,   alertType: AlertType.PEAK_DEMAND,         status: AlertStatus.OPEN,          title: "Peak Demand Listrik Melewati Kontrak",         description: "Demand 4.2 MVA > kontrak 4.0 MVA", metricName: "demand_kVA", metricValue: 4200, threshold: 4000, openedAt: d(0), acknowledgedAt: null, resolvedAt: null, closedAt: null, rootCause: null, resolution: null, slaDeadline: null, createdAt: d(0), updatedAt: d(0) },
...
export const MOCK_REPORTS = [
  { id: "rpt_01", generatedBy: "usr_3", reportType: "monthly_energy",      title: "Laporan Energi Bulanan – April 2026",      period: "April 2026",     status: "ready",      fileUrl: null, parameters: { pillar: "ELECTRICITY", sites: ["ste_1","ste_2"] }, createdAt: d(5)  },
...
const actions = ["LOGIN", "ALERT_ACKNOWLEDGED", "ALERT_RESOLVED", "REPORT_GENERATED", "USER_UPDATED", "SENSOR_UPDATED"];
...
// ─── Relations map ────────────────────────────────────────────────────────────
// Tells the resolver how to join models: { modelField: [relatedArray, foreignKey, localKey] }
...
// Count relation mappings: which model array to count for each _count key
